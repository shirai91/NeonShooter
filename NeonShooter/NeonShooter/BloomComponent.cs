...
namespace BloomPostprocess
{
    public class BloomComponent : DrawableGameComponent
    {
        ...
        public void LoadContent(GraphicsDevice g, ContentManager theContentManager)
        {
            ...
            bloomExtractEffect = theContentManager.Load<Effect>("Shaders/BloomExtract");
            bloomCombineEffect = theContentManager.Load<Effect>("Shaders/BloomCombine");
            gaussianBlurEffect = theContentManager.Load<Effect>("Shaders/GaussianBlur");
            ...
            renderTarget1 = new RenderTarget2D(g, width, height, false, format, DepthFormat.None);
            renderTarget2 = new RenderTarget2D(g, width, height, false, format, DepthFormat.None);
        }
